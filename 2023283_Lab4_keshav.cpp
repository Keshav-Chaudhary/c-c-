...
int main() {
    ...
    cout << "Max_sum for Scenario 1 is " << Maxysumsubarraysum(arr1, 0, n1-1) << endl;
    cout << "Max_sum for Scenario 2 is " << Maxysumsubarraysum(arr2, 0, n2-1) << endl;
    cout << "Max_sum for Scenario 3 is " << Maxysumsubarraysum(arr3, 0, n3-1) << endl;
